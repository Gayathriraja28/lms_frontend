...
{/* review and ratings */}
<div className='flex items-center space-x-2 p1-3 pb-1 text-sm'>
        ...
        <p className='text-voilet-600'>({courseData.courseRatings.length} {courseData.courseRatings.length > 1? 'ratings' : 'rating'})</p>
        <p>{courseData.enrolledStudents.length} {courseData.enrolledStudents.length > 1 ? 'students' : 'student'}</p>
      </div>
      <p className='text-sm'>Course by <span className='text-violet-600 underline'>Learning Academy</span></p>
                  ...
                  <li key={i} className='flex items-start gap-2 py-1'>
                    ...
                    <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                      ...
                      <div className='flex gap-2'>
                        {lecture.isPreviewFree && <p className='text-violet-500 cursor-pointer'>Preview</p>}
